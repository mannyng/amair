...
app.controller("CustomerSearchController", [
  ...
  function($scope , $http, $location) {
   ...
   $http.get("/customers.json", { "params": { "keywords": searchTerm, "page": page } } ).then(function(response) { $scope.customers = response.data; },
...
app.controller("CustomerDetailController", [
   ...
   // Make the Ajax call and set the $scope.customer....
